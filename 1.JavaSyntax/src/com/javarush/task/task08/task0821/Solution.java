...
public class Solution {
    ...
    public static Map<String, String> createPeopleMap() {
        ...
        map.put("Наникова","Элизабет");
        map.put("Васенко","Лиза");
        map.put("Васенко","Елизавета");
        map.put("Грунин","Николай");
        map.put("Грунин","Иван");
        map.put("Шапченко","Оксана");
        map.put("Шиловская","Екатерина");
        map.put("Стрельченко","Анстасия");
        map.put("Мюнстер","Анастасия");
        map.put("Тейлор","Элизабет");
